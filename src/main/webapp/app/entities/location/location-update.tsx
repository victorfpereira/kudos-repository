  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="kudinhoStoreApp.location.home.createOrEditLabel" data-cy="LocationCreateUpdateHeading">
            <Translate contentKey="kudinhoStoreApp.location.home.createOrEditLabel">Create or edit a Location</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('kudinhoStoreApp.location.streetAddress')}
              ...
              />
              <ValidatedField
                label={translate('kudinhoStoreApp.location.postalCode')}
              ...
              />
              <ValidatedField
                label={translate('kudinhoStoreApp.location.city')}
                id="location-city"
                name="city"
                data-cy="city"
                type="text"
              />
              <ValidatedField
                label={translate('kudinhoStoreApp.location.stateProvince')}
              ...
              <ValidatedField
                ...
                name="country"
                data-cy="country"
                label={translate('kudinhoStoreApp.location.country')}
                type="select"
              >
                <option value="" key="0" />
                {countries
