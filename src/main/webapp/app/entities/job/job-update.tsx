  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="kudinhoStoreApp.job.home.createOrEditLabel" data-cy="JobCreateUpdateHeading">
            <Translate contentKey="kudinhoStoreApp.job.home.createOrEditLabel">Create or edit a Job</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('kudinhoStoreApp.job.jobTitle')}
                id="job-jobTitle"
                name="jobTitle"
                data-cy="jobTitle"
                type="text"
              />
              <ValidatedField
                label={translate('kudinhoStoreApp.job.minSalary')}
                id="job-minSalary"
                name="minSalary"
                data-cy="minSalary"
                type="text"
              />
              <ValidatedField
                label={translate('kudinhoStoreApp.job.maxSalary')}
                id="job-maxSalary"
                name="maxSalary"
                data-cy="maxSalary"
                type="text"
              />
              <ValidatedField
                label={translate('kudinhoStoreApp.job.task')}
                id="job-task"
                data-cy="task"
                type="select"
                multiple
              ...
              <ValidatedField
                ...
                name="employee"
                data-cy="employee"
                label={translate('kudinhoStoreApp.job.employee')}
                type="select"
              >
                <option value="" key="0" />
                {employees
