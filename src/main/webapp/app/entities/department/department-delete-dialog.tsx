...
export const DepartmentDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="kudinhoStoreApp.department.delete.question">
        <Translate contentKey="kudinhoStoreApp.department.delete.question" interpolate={{ id: departmentEntity.id }}>
