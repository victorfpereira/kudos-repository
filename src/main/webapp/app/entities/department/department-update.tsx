  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="kudinhoStoreApp.department.home.createOrEditLabel" data-cy="DepartmentCreateUpdateHeading">
            <Translate contentKey="kudinhoStoreApp.department.home.createOrEditLabel">Create or edit a Department</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('kudinhoStoreApp.department.departmentName')}
              ...
              <ValidatedField
                ...
                name="location"
                data-cy="location"
                label={translate('kudinhoStoreApp.department.location')}
                type="select"
              >
                <option value="" key="0" />
                {locations
