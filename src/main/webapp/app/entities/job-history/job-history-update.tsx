  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="kudinhoStoreApp.jobHistory.home.createOrEditLabel" data-cy="JobHistoryCreateUpdateHeading">
            <Translate contentKey="kudinhoStoreApp.jobHistory.home.createOrEditLabel">Create or edit a JobHistory</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('kudinhoStoreApp.jobHistory.startDate')}
              ...
              />
              <ValidatedField
                label={translate('kudinhoStoreApp.jobHistory.endDate')}
              ...
              />
              <ValidatedField
                label={translate('kudinhoStoreApp.jobHistory.language')}
              ...
              >
                {languageValues.map(language => (
                  <option value={language} key={language}>
                    {translate('kudinhoStoreApp.Language.' + language)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedField
                ...
                name="job"
                data-cy="job"
                label={translate('kudinhoStoreApp.jobHistory.job')}
                type="select"
              >
                <option value="" key="0" />
                {jobs
              ...
              <ValidatedField
                ...
                name="department"
                data-cy="department"
                label={translate('kudinhoStoreApp.jobHistory.department')}
                type="select"
              >
                <option value="" key="0" />
                {departments
              ...
              <ValidatedField
                ...
                name="employee"
                data-cy="employee"
                label={translate('kudinhoStoreApp.jobHistory.employee')}
                type="select"
              >
                <option value="" key="0" />
                {employees
