...
export const JobHistoryDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="kudinhoStoreApp.jobHistory.delete.question">
        <Translate contentKey="kudinhoStoreApp.jobHistory.delete.question" interpolate={{ id: jobHistoryEntity.id }}>
